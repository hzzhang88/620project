...
### federated learning -- 'blue' version 
beta1 = ssxy/ssx = (beta1.1*ssx.1 +beta1.2*ssx.2+ beta1.2*ssx.3 )
```{r}
i_ssx1 = sum((t1[[x]] - mean(t1[[x]]))^2)
i_ssxy1 = sum((t1[[x]] - mean(t1[[x]]))*(t1[[y]] - mean(t1[[y]])))
i_ssx2 = sum((t2[[x]] - mean(t2[[x]]))^2)
i_ssxy2 = sum((t2[[x]] - mean(t2[[x]]))*(t2[[y]] - mean(t2[[y]])))
i_ssx3 = sum((t3[[x]] - mean(t3[[x]]))^2)
i_ssxy3 = sum((t3[[x]] - mean(t3[[x]]))*(t3[[y]] - mean(t3[[y]])))
beta1_meta = (i_ssxy1+i_ssxy2+i_ssxy3)/(i_ssx1+i_ssx2+i_ssx3)
