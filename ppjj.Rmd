...
t1[['first_pick']] = hour(t1$pickups_1st) + minute(t1$pickups_1st)/60
t2[['first_pick']] = hour(t2$pickups_1st) + minute(t2$pickups_1st)/60
t3[['first_pick']] = hour(t3$pickups_1st) + minute(t3$pickups_1st)/60
t1 = cbind(t1,id = 1)
t2 = cbind(t2,id = 2)
t3 = cbind(t3,id = 3)
